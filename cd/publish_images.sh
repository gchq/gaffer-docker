...
pushTags gchq/gaffer "${GAFFER_VERSION}-accumulo-${ACCUMULO_VERSION}" "${APP_VERSION}"
pushTags gchq/gaffer-rest "${GAFFER_VERSION}" "${APP_VERSION}"
pushTags gchq/gaffer-rest "${GAFFER_VERSION}-accumulo-${ACCUMULO_VERSION}" "${APP_VERSION}"
