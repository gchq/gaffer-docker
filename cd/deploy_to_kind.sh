...
kind load docker-image gchq/gaffer:1.18.0
kind load docker-image gchq/gaffer-rest:1.18.0
kind load docker-image gchq/gaffer-ui:1.18.0
kind load docker-image gchq/gaffer-road-traffic-loader:1.18.0
kind load docker-image gchq/gaffer-operation-runner:1.18.0
