...
kind load docker-image gchq/gaffer:1.16.1
kind load docker-image gchq/gaffer-rest:1.16.1
kind load docker-image gchq/gaffer-ui:1.16.1
kind load docker-image gchq/gaffer-road-traffic-loader:1.16.1
kind load docker-image gchq/gaffer-operation-runner:1.16.1
